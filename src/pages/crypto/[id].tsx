      ...
      <div className="container mt-5 d-flex justify-content-center">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              <b>Market Cap:</b> ₹{cryptoData.market_data.market_cap.inr}
            </p>
            <p className="card-text">
              <b>Current Price:</b> ₹{cryptoData.market_data.current_price.inr}
            </p>
            <p className="card-text">
              <b>Total Supply:</b> {cryptoData.market_data.total_supply}
            </p>
            <p className="card-text">
              <b>Market Cap Change (24h):</b> {cryptoData.market_data.market_cap_change_percentage_24h}%
            </p>
            <p className="card-text">
              <b>High (24h):</b> ₹{cryptoData.market_data.high_24h.inr}
            </p>
            <p className="card-text">
              <b>Low (24h):</b> ₹{cryptoData.market_data.low_24h.inr}
            </p>
            <p className="card-text">
              <b>Total Volume (24h):</b> ₹{cryptoData.market_data.total_volume.inr}
            </p>
            <p className="card-text">
              <b>Circulating Supply:</b> {cryptoData.market_data.circulating_supply}
            </p>
          </div>
        </div>
      </div>
